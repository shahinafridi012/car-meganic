...
import img from '../../assets/car-repair-costs-hero_1_1.webp'
...
const Login = () => {
    ...
    const handleLogin = e => {
        ...
        signIn(email, password)
            .then(result => {
                Swal.fire("You Successfully Logined");
            ...
            .catch(error => {
                console.log(error)
                Swal.fire(error.message, 'something wrong in your pass or email');
            })
    }
    const HandleGGlogin = () => {
        googleSignIn()
    ...
    return (
        <div className="flex bg-gray-100 w-full max-w-sm mx-auto overflow-hidden text-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            <div
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                <div className="flex justify-center mx-auto">
                    <img className=" h-7 sm:h-8" src={logo} alt="" />
                </div>
                ...
                <button onClick={HandleGGlogin}
                    ...
                    text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
                >
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <Link to='/signup'> <h1 href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">
                            or sign up
                        </h1></Link>
                        <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4" />
                    </div>
